...
<html xmlns="http://www.w3.org/1999/xhtml">
   ...
   <body style="margin-bottom: 0%">
      <form id="form1" runat="server">
         ...
         <div class="slider">
            <div class="callbacks_container">
               <ul class="rslides" id="slider">
                  <li>
                     <div class="slider-info" style=" background-color: #008080">
                        <h3 class="auto-style1">Hunbel Hotel</h3>
                        <p style="color:#fff; font-size: 18px; margin-left:5%; height: auto; left: 10%;">Hunbel tiêu chuẩn bao gồm các khách sạn 3-4 sao, nằm ở trung tâm
                            ...
                            bạn như rũ bỏ một ngày dài căng thẳng với một loạt tiện nghi như tivi màn hình phẳng, internet không dây, internet không dây (miễn phí),
                            máy điều hòa, bàn trong một số phòng. Bên cạnh đó, khách sạn còn gợi ý cho bạn những hoạt động vui chơi giải trí bảo đảm bạn luôn thấy 
                            hứng thú trong suốt kì nghỉ. Hunbel Hotel là một nơi lý tưởng cho du khách nghỉ chân tìm kiếm sự thoải mái và tiện nghi ở Vinh.</p>
                     </div>
                  </li>
               </ul>
            </div>
         ...
         <div class="main" id="main" style="right: 6%; bottom: -5%; color: #FF0000; top: 27%; left: 791px; margin-left: 4px;" >
            <div class="w3layouts_main_grid" style="background-color: #C0C0C0;  bottom: 16%; height: 546px; color: #000000; border-radius: 5%;">
               <div>
                  ...
                  <div>
                     <h5 style="color: #000000">Số điện thoại </h5>
                     <asp:TextBox ID="txtPhone" runat="server" placeholder="Số điện thoại" required="" Width="400px" />
                  </div>
                  <div>
